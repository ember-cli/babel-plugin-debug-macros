...
function createTests(options) {
  ...
  describe('Feature Flags', function() {
    ...
    h.generateErrorTest('missing-feature-flag', 'Imported FEATURE_C from @ember/features which is not a supported flag.');
  });
    ...
    return {
      generateTest(fixtureName) {
        it(fixtureName, function() {
          ...
          let expectation = fs.readFileSync(`./fixtures/${fixtureName}/expectation${babelVersion}.js`, 'utf-8');
